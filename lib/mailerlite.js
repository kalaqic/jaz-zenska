...
const GROUPS = {
    ...
    WEBINAR_MOC_BESEDE: '184176946500863554',
    ...
    // Waiting for payment – Moč besede course (set MAILERLITE_GROUP_WAITING_MOC_BESEDE in Vercel)
    WAITING_MOC_BESEDE: process.env.MAILERLITE_GROUP_WAITING_MOC_BESEDE || '',
    IN_GROUP: '180183704629413845',
    EBOOK: '180183130920978410',
    CONSULTATION: '180183211500897362',
    // Free workshop – Moj jutranji obred (set MAILERLITE_GROUP_JUTRANJI_OBRED in Vercel)
    JUTRANJI_OBRED: process.env.MAILERLITE_GROUP_JUTRANJI_OBRED || '',
